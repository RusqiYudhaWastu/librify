...
<head>
    ...
    <style>
        ...
        .data-table tr:nth-child(even) { background-color: #ecfeff; } /* Light Cyan bg */
    ...
    <div class="info-box">
        ...
        <table class="info-table">
            ...
            <tr>
                ...
                <td class="value">: Sistem Librify Member</td>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th style="width: 175px;">Rincian Buku & Kuantitas</th>
                <th style="width: 110px;">Jadwal & Durasi</th>
                <th style="width: 60px; text-align: center;">Status</th>
                <th>Insiden & Total Denda</th>
            </tr>
        </thead>
        <tbody>
            @php
            ...
            @php
                ...
                // Status Lunas (Unpaid = ada hutang)
                ...
                <td>
                    ...
                    @else
                        <span style="color: #166534; font-size: 8px; font-weight: bold;">
                            @if($first->status === 'returned') Aman tanpa denda. @else - @endif
                        </span>
                    @endif
                </td>
            </tr>
    ...
    <table class="footer">
        <tr>
            ...
            <td class="sign-col">
                ...
                <div class="sign-role">Siswa Individu (Member)</div>
            </td>
        </tr>
    </table>
