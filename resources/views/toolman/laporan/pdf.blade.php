...
<head>
    <meta charset="UTF-8">
    <title>Laporan Kerja Toolman - {{ $summary['toolman'] }}</title>
    <style>
        /* --- RESET & DASAR --- */
        ...
        .header h1 { font-size: 16px; font-weight: 800; margin: 0; text-transform: uppercase; color: #064e3b; letter-spacing: 1px; }
        ...
        /* --- RINGKASAN DATA --- */
        .info-box { width: 100%; margin-bottom: 20px; border: 1px solid #e2e8f0; padding: 10px; background-color: #f0fdf4; }
        .info-table { width: 100%; border: none; }
        .info-table td { padding: 2px; border: none; vertical-align: top; }
        .label { font-weight: bold; width: 110px; color: #064e3b; text-transform: uppercase; font-size: 9px; }
        .value { color: #0f172a; font-weight: bold; }

        /* --- TABEL UTAMA --- */
        .data-table { width: 100%; border-collapse: collapse; margin-top: 10px; table-layout: fixed; }
        .data-table th { background-color: #064e3b; color: #ffffff; padding: 8px 6px; text-transform: uppercase; font-size: 8px; border: 1px solid #064e3b; text-align: left; }
...
<body>
    ...
    {{-- HEADER --}}
    <div class="header">
        <h1>Laporan Rekapitulasi Kerja Toolman</h1>
        <h2>SMK NEGERI 1 CIOMAS - UNIT TEKNOLOGI & LOGISTIK</h2>
        <p>Arsip Internal Pengelolaan Aset Bengkel & Laboratorium</p>
    </div>
    ...
    <div class="info-box">
        <table class="info-table">
            <tr>
                <td class="label">Nama Toolman</td>
                <td class="value">: {{ $summary['toolman'] }}</td>
                <td class="label">Periode Data</td>
                <td class="value">: {{ $summary['period'] }}</td>
            </tr>
            <tr>
                <td class="label">Total Log</td>
                <td class="value">: {{ $data->count() }} Transaksi</td>
    ...
    <table class="footer">
        <tr>
            <td class="sign-col">
                <p>Mengetahui,<br>Kepala Unit Sarpras</p>
            ...
            <td class="sign-col">
                ...
                <div class="sign-space"></div>
                <div class="sign-name">{{ $summary['toolman'] }}</div>
                <div class="sign-role">Petugas Toolman</div>
            </td>
        </tr>
    </table>
