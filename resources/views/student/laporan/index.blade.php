                                ...
                                <tbody class="divide-y divide-gray-50">
                                    ...
                                    <tr class="group hover:bg-gray-50/50 transition-all duration-200"
                                        ...
                                        <td class="px-8 py-5 text-center">
                                            ...
                                            }; modalDetail = true" class="w-9 h-9 rounded-xl bg-slate-100 text-slate-500 hover:bg-cyan-600 hover:text-white transition-all flex items-center justify-center shadow-sm mx-auto">
                ...
                <div x-show="activeTab === 'laporan'" x-transition x-cloak>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div x-show="searchQuery === '' || '{{ strtolower($report->item->name) }}'.includes(searchQuery.toLowerCase())" 
                            ...
                            {{-- ✅ Tombol Detail Laporan (Passing Data Foto) --}}
                            <button @click="detailData = {
                                type: 'report',
                            ...
                            }; modalDetail = true" class="w-full py-4 bg-slate-900 text-white rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-cyan-600 transition-all shadow-lg active:scale-95">
                                Lihat Detail
                            </button>
                        </div>
                        @empty
